...
test("the production home still exposes and manages saved folders and apps", () => {
  ...
  assert.ok(html.indexOf('id="workspace-folders"') < html.indexOf('id="project-timelines"'), "folders appear before timelines");
  assert.match(html, /class="workspace-folders spacious-folders"/);
  assert.match(css, /\.spacious-folders \.folder-workspace\{min-height:520px/);
  assert.match(css, /\.spacious-folders \.home-folder\{min-height:84px/);
