...
async function startDesktopShell() {
  ...
  ipcMain.handle("magicus:launch-app", (_event, shortcut) => {
    ...
    const win = new BrowserWindow({ title: shortcut.name || APP_TITLE, width: 1180, height: 780, minWidth: 640, minHeight: 480, autoHideMenuBar: true, backgroundColor: "#090a0d", webPreferences: { nodeIntegration: false, contextIsolation: true, sandbox: true } });
    win.removeMenu();
